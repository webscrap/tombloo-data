...
function load_bookmark(){
	...
	var filename = "data/" + DATA[CURIDX] + ".js";
	hd.setAttribute('href',filename);
	hd.innerHTML = '&lt;' + filename + '&gt;';
...
function load_page(page) {
	...
	var pagetip = document.getElementById('bm_curpage1');
	pagetip.innerHTML = "[" + DATA[page] + "]";
	var pagetip = document.getElementById('bm_curpage2');
	pagetip.innerHTML = "[" + DATA[page] + "]";
	window.setTimeout(function(){return load_bookmark()},500);
}
